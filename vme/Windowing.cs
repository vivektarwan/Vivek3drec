...
namespace vme
{
    public partial class Windowing : UserControl
    {
        ...
        void DrawLines(Graphics g)
        {
            ...
            // Presenting the center of the window line (level)
            Point pt3 = new Point();
            Point pt4 = new Point();
            p.Width = 2;
            pt3.X = (pt1.X + pt2.X) / 2;
        ...
        private void DrawAxesLabels(Graphics gr)
        {
            ...
            gr.DrawString("Brightness", f, br, p, sf);
        ...
        private void Windowing_Paint(object sender, PaintEventArgs e)
        {
            ...
            text_centre.Text = "Center=" + winCentreToDisplay.ToString();
            text_min.Text = "Min. = " + winMinToDisplay.ToString();
            text_max.Text = "Max. =" + winMaxToDisplay.ToString();
