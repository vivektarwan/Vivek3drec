...
namespace vme
{
    public partial class Canvas : UserControl
    {
        ...
        public void SetParameters(ref List<ushort> arr,double intercept, int wid, int hei, double windowWidth,   
            ...
            unsafe
            {
                ...
                for (i = 0; i < bmd.Height; ++i)
                {
                    ...
                    for (j = 0; j < bmd.Width; ++j)
                    {
                        ...
                        histogram[b]++; // histogram for a cut [0..255]
                ...
                //viewcolor = false;  // so I can always watch a color image is not reset to default settings
            }
            bmp.UnlockBits(bmd);
        }

        /* works for ushort and short, even though I work here only с ushort */
        ...
        private void Surface_MouseMove(object sender, MouseEventArgs e)
        {
            if (rightMouseDown == true)
            {
                ...
                {
                    ComputeLookUpTable16();
                    CreateImage16(); //  is calculated as the histogram
                }
                UpdateMainForm();
                Invalidate();
            }
