...
namespace vme
{
    class JpegDictionary
    {
        ...
        {
        /*Start of frame markers  - marks the beginning of the frame*/
        {"FFC0","Baseline DCT"},
        ...
        /* Start of frame markers  Differential Huffman coding - marks the beginning of a frame Diferrentsialnoe Huffman coding*/
        ...
        /*Start and end of image markers - marks the beginning and end of the image */
        {"FFD8","Start of image"},
        {"FFD9","End of Image"},
